...
class GirlsOurContent extends StatefulWidget {
  @override
  _GirlsOurContentState createState() => _GirlsOurContentState();
}

class _GirlsOurContentState extends State<GirlsOurContent> {
